...
async function loadEndpoints() {
  ...
  try {
    const res = await webhookApi.getEndpoints(SCOPE_TYPE, orgId)
...
async function loadIncomingWebhooks() {
  ...
  try {
    const res = await webhookApi.getIncomingWebhooks(SCOPE_TYPE, orgId)
...
async function loadApiKeys() {
  ...
  try {
    const res = await webhookApi.getApiKeys(SCOPE_TYPE, orgId)
