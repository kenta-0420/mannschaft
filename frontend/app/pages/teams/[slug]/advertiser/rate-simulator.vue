...
// F09.19.6 チームスコープ 料金シミュレーター。
// rate-simulator / rate-cards は scope 非依存 API（/api/v1/advertiser/*）のため、
// 組織版 (pages/organizations/[slug]/advertiser/rate-simulator.vue) と全く同一の呼び出しで動作する
// （正本 docs/features/F09.19_ad_slot_serving.md §9）。
...
<template>
  <div class="mx-auto max-w-3xl">
    <PageHeader :title="t('advertising.teams_page.rate_simulator.title')" />
