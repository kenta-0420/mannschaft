...
function confirmDelete() {
  confirm.require({
    message: t('settings.settings.delete_account.confirm_message'),
    header: t('settings.settings.delete_account.confirm_dialog_title'),
    icon: 'pi pi-exclamation-triangle',
    rejectLabel: t('settings.settings.delete_account.confirm_reject_label'),
    acceptLabel: t('settings.settings.delete_account.confirm_accept_label'),
