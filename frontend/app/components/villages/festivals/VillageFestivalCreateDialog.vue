...
/**
 * 村お祭り作成 Dialog — 表示専用の子コンポーネント。
 *
 * フォーム状態と投稿主体は親 (pages/villages/[id]/festivals.vue) が保持し、
 * 子は表示と入力イベントの転送に専念する。
 *
...
const postingIdentity = defineModel<PostingIdentitySelection | null>('postingIdentity', { required: true })
