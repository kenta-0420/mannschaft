...
export default defineConfig({
  ...
  testMatch:
    /f0810-(basketball-continuous|volleyball-sets|live-spectator-ws|shogi-turn|go-turn|position-photo|team-match-board|scored-figure-gymnastics|scored-components|scored-entries|phase5b-canonical-match)\.spec\.ts/,
  fullyParallel: false,
  retries: 0,
  workers: 1,
  reporter: [['list']],
