...
- タグチップは、未選択のチーム/組織を押下すると選択し、選択済みのチップを再度押下すると該当するチーム/組織ページへ遷移する。選択済みチップのアクセシブル名で、再押下時のページ遷移を説明する。
...
チーム/組織タグは、未選択なら選択し、選択済みを再押下すると個別ページへ遷移する。選択済みチップのアクセシブル名で操作結果（個別ページを開く）を説明する。
