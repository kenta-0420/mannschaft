...
- エラー：`PAYMENT_REQUEST_NOT_FOR_THIS_TEAM`(403)／`PAYMENT_REQUEST_ALREADY_PAID`(409)／`PAYMENT_REQUEST_INVALID_STATUS`(409・取消/配信/支払いの状態制約)／`PAYMENT_REQUEST_CONNECT_NOT_READY`(409)／`PAYMENT_ADVANCE_NOT_FOUND`(404)／`PAYMENT_ADVANCE_ALREADY_SETTLED`(409)。
