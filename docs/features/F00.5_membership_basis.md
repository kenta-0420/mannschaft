...
| バージョン | 日付 | 内容 |
|---|---|---|
| v1.3 | 2026-05-05 | **Phase 5 着手**: JobPolicy.canApply() の SUPPORTER 判定を memberships 経由に切替（AccessControlService.isSupporter() 追加） / board.vue の isSupporter 判定を systemRole 参照から useRoleAccess 経由に修正 / V60.011 移行ドキュメント記録 SQL 追加 |
