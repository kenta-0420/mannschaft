# API 乖離ベースライン報告書（2026-05-16 時点）

> 本報告書は `backend/scripts/scan_api_drift.py` により自動生成された。
> 設計書 `docs/features/F*.md` のテーブル/見出し記載と、
> 実装 `backend/src/main/java/**/controller/*Controller.java` の
> Spring MVC アノテーションを突合した結果である。
...
- 実装あり・設計なし: **931 件**
- 一致: **1310 件**
- 設計記載 ユニーク (method, path) 総数: 2497
- 実装 ユニーク (method, path) 総数: 2241
...
### /api/v1/confirmable-notifications/* (3 件)
...
| GET | `/api/v1/organizations/{_}/members/contactable` | `ContactableMemberController#getOrgContactableMembers` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactableMemberController.java) | 41 |
...
| GET | `/api/v1/organizations/{_}/teams/search` | `OrganizationTeamSearchController#search` (backend/src/main/java/com/mannschaft/app/team/controller/OrganizationTeamSearchController.java) | 85 |
...
| POST | `/api/v1/organizations/{_}/tournaments/{_}/divisions/{_}/participants/{_}/entry-members/apply-template` | `TournamentEntryTemplateController#applyTemplate` (backend/src/main/java/com/mannschaft/app/tournament/entry/TournamentEntryTemplateController.java) | 148 |
...
| GET | `/api/v1/teams/{_}/members/contactable` | `ContactableMemberController#getTeamContactableMembers` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactableMemberController.java) | 28 |
...
| DELETE | `/api/v1/{_}/{_}/bulletin/categories/{_}` | `BulletinCategoryController#deleteCategory` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinCategoryController.java) | 102 |
| DELETE | `/api/v1/{_}/{_}/bulletin/threads/{_}` | `BulletinThreadController#deleteThread` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinThreadController.java) | 133 |
| DELETE | `/api/v1/{_}/{_}/bulletin/threads/{_}/replies/{_}` | `BulletinReplyController#deleteReply` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinReplyController.java) | 96 |
| DELETE | `/api/v1/{_}/{_}/form-submissions/{_}` | `FormSubmissionController#deleteSubmission` (backend/src/main/java/com/mannschaft/app/forms/controller/FormSubmissionController.java) | 106 |
| DELETE | `/api/v1/{_}/{_}/form-templates/{_}` | `FormTemplateController#deleteTemplate` (backend/src/main/java/com/mannschaft/app/forms/controller/FormTemplateController.java) | 135 |
| DELETE | `/api/v1/{_}/{_}/repair-plan/handover-packs/{_}` | `BoardHandoverPackController#deletePack` (backend/src/main/java/com/mannschaft/app/repairplan/controller/BoardHandoverPackController.java) | 101 |
| DELETE | `/api/v1/{_}/{_}/repair-plan/items/{_}` | `RepairPlanItemController#delete` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanItemController.java) | 137 |
| DELETE | `/api/v1/{_}/{_}/surveys/{_}` | `SurveyController#deleteSurvey` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyController.java) | 141 |
| DELETE | `/api/v1/{_}/{_}/surveys/{_}/questions/{_}` | `SurveyQuestionController#deleteQuestion` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyQuestionController.java) | 49 |
| DELETE | `/api/v1/{_}/{_}/workflow-requests/{_}` | `WorkflowRequestController#deleteRequest` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowRequestController.java) | 134 |
| DELETE | `/api/v1/{_}/{_}/workflow-templates/{_}` | `WorkflowTemplateController#deleteTemplate` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowTemplateController.java) | 105 |
...
| GET | `/api/v1/{_}/{_}/bulletin/categories/{_}` | `BulletinCategoryController#getCategory` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinCategoryController.java) | 56 |
| GET | `/api/v1/{_}/{_}/bulletin/threads/search` | `BulletinThreadController#searchThreads` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinThreadController.java) | 83 |
| GET | `/api/v1/{_}/{_}/bulletin/threads/{_}` | `BulletinThreadController#getThread` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinThreadController.java) | 68 |
| GET | `/api/v1/{_}/{_}/form-submissions/my` | `FormSubmissionController#listMySubmissions` (backend/src/main/java/com/mannschaft/app/forms/controller/FormSubmissionController.java) | 43 |
| GET | `/api/v1/{_}/{_}/form-submissions/{_}` | `FormSubmissionController#getSubmission` (backend/src/main/java/com/mannschaft/app/forms/controller/FormSubmissionController.java) | 61 |
| GET | `/api/v1/{_}/{_}/form-templates/{_}` | `FormTemplateController#getTemplate` (backend/src/main/java/com/mannschaft/app/forms/controller/FormTemplateController.java) | 62 |
| GET | `/api/v1/{_}/{_}/property-history/categories/suggestions` | `PropertyWorkPackageController#categorySuggestions` (backend/src/main/java/com/mannschaft/app/property/controller/PropertyWorkPackageController.java) | 329 |
| GET | `/api/v1/{_}/{_}/property-history/gantt` | `PropertyWorkPackageController#gantt` (backend/src/main/java/com/mannschaft/app/property/controller/PropertyWorkPackageController.java) | 163 |
| GET | `/api/v1/{_}/{_}/repair-plan/handover-packs/{_}/download` | `BoardHandoverPackController#getDownloadUrl` (backend/src/main/java/com/mannschaft/app/repairplan/controller/BoardHandoverPackController.java) | 86 |
| GET | `/api/v1/{_}/{_}/repair-plan/items/{_}` | `RepairPlanItemController#get` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanItemController.java) | 109 |
| GET | `/api/v1/{_}/{_}/repair-plan/quote-kanbans/{_}` | `RepairPlanQuoteKanbanController#getKanban` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanQuoteKanbanController.java) | 97 |
| GET | `/api/v1/{_}/{_}/repair-plan/scenarios/{_}` | `RepairPlanScenarioController#getScenario` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanScenarioController.java) | 114 |
| GET | `/api/v1/{_}/{_}/surveys/stats` | `SurveyController#getStats` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyController.java) | 174 |
| GET | `/api/v1/{_}/{_}/surveys/{_}` | `SurveyController#getSurvey` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyController.java) | 69 |
| GET | `/api/v1/{_}/{_}/surveys/{_}/respondents` | `SurveyController#getRespondents` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyController.java) | 158 |
| GET | `/api/v1/{_}/{_}/vendors/search` | `VendorController#searchVendors` (backend/src/main/java/com/mannschaft/app/property/controller/VendorController.java) | 103 |
| GET | `/api/v1/{_}/{_}/workflow-requests/{_}` | `WorkflowRequestController#getRequest` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowRequestController.java) | 62 |
| GET | `/api/v1/{_}/{_}/workflow-templates/{_}` | `WorkflowTemplateController#getTemplate` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowTemplateController.java) | 61 |
...
| PATCH | `/api/v1/{_}/{_}/repair-plan/items/{_}` | `RepairPlanItemController#update` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanItemController.java) | 121 |
| PATCH | `/api/v1/{_}/{_}/repair-plan/quote-kanbans/{_}` | `RepairPlanQuoteKanbanController#updateKanban` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanQuoteKanbanController.java) | 111 |
| PATCH | `/api/v1/{_}/{_}/surveys/{_}` | `SurveyController#updateSurvey` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyController.java) | 98 |
...
| POST | `/api/v1/{_}/{_}/bulletin/threads/{_}/archive` | `BulletinThreadController#archive` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinThreadController.java) | 178 |
| POST | `/api/v1/{_}/{_}/bulletin/threads/{_}/lock` | `BulletinThreadController#toggleLock` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinThreadController.java) | 163 |
| POST | `/api/v1/{_}/{_}/bulletin/threads/{_}/pin` | `BulletinThreadController#togglePin` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinThreadController.java) | 148 |
| POST | `/api/v1/{_}/{_}/form-templates/{_}/close` | `FormTemplateController#closeTemplate` (backend/src/main/java/com/mannschaft/app/forms/controller/FormTemplateController.java) | 121 |
| POST | `/api/v1/{_}/{_}/form-templates/{_}/publish` | `FormTemplateController#publishTemplate` (backend/src/main/java/com/mannschaft/app/forms/controller/FormTemplateController.java) | 107 |
| POST | `/api/v1/{_}/{_}/form-templates/{_}/submissions/{_}/approve` | `FormSubmissionAdminController#approveSubmission` (backend/src/main/java/com/mannschaft/app/forms/controller/FormSubmissionAdminController.java) | 54 |
| POST | `/api/v1/{_}/{_}/form-templates/{_}/submissions/{_}/reject` | `FormSubmissionAdminController#rejectSubmission` (backend/src/main/java/com/mannschaft/app/forms/controller/FormSubmissionAdminController.java) | 69 |
| POST | `/api/v1/{_}/{_}/form-templates/{_}/submissions/{_}/return` | `FormSubmissionAdminController#returnSubmission` (backend/src/main/java/com/mannschaft/app/forms/controller/FormSubmissionAdminController.java) | 84 |
| POST | `/api/v1/{_}/{_}/property-history/export` | `PropertyWorkPackageController#exportList` (backend/src/main/java/com/mannschaft/app/property/controller/PropertyWorkPackageController.java) | 300 |
| POST | `/api/v1/{_}/{_}/property-history/{_}/export` | `PropertyWorkPackageController#exportSingle` (backend/src/main/java/com/mannschaft/app/property/controller/PropertyWorkPackageController.java) | 287 |
| POST | `/api/v1/{_}/{_}/repair-plan/quote-cards/{_}/move` | `RepairPlanQuoteKanbanController#moveCard` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanQuoteKanbanController.java) | 147 |
| POST | `/api/v1/{_}/{_}/repair-plan/quote-kanbans/{_}/cards` | `RepairPlanQuoteKanbanController#addCard` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanQuoteKanbanController.java) | 129 |
| POST | `/api/v1/{_}/{_}/repair-plan/scenarios/{_}/pin-to-corkboard` | `RepairPlanScenarioController#pinToCorkboard` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanScenarioController.java) | 145 |
| POST | `/api/v1/{_}/{_}/repair-plan/scenarios/{_}/publish-as-announcement` | `RepairPlanScenarioController#publishAsAnnouncement` (backend/src/main/java/com/mannschaft/app/repairplan/controller/RepairPlanScenarioController.java) | 128 |
| POST | `/api/v1/{_}/{_}/surveys/{_}/close` | `SurveyController#closeSurvey` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyController.java) | 127 |
| POST | `/api/v1/{_}/{_}/surveys/{_}/publish` | `SurveyController#publishSurvey` (backend/src/main/java/com/mannschaft/app/survey/controller/SurveyController.java) | 113 |
| POST | `/api/v1/{_}/{_}/workflow-requests/{_}/submit` | `WorkflowRequestController#submitRequest` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowRequestController.java) | 106 |
| POST | `/api/v1/{_}/{_}/workflow-requests/{_}/withdraw` | `WorkflowRequestController#withdrawRequest` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowRequestController.java) | 120 |
| POST | `/api/v1/{_}/{_}/workflow-templates/{_}/activate` | `WorkflowTemplateStatusController#activateTemplate` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowTemplateStatusController.java) | 29 |
| POST | `/api/v1/{_}/{_}/workflow-templates/{_}/deactivate` | `WorkflowTemplateStatusController#deactivateTemplate` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowTemplateStatusController.java) | 43 |
...
| PUT | `/api/v1/{_}/{_}/bulletin/categories/{_}` | `BulletinCategoryController#updateCategory` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinCategoryController.java) | 86 |
| PUT | `/api/v1/{_}/{_}/bulletin/threads/{_}` | `BulletinThreadController#updateThread` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinThreadController.java) | 117 |
| PUT | `/api/v1/{_}/{_}/bulletin/threads/{_}/replies/{_}` | `BulletinReplyController#updateReply` (backend/src/main/java/com/mannschaft/app/bulletin/controller/BulletinReplyController.java) | 79 |
| PUT | `/api/v1/{_}/{_}/form-submissions/{_}` | `FormSubmissionController#updateSubmission` (backend/src/main/java/com/mannschaft/app/forms/controller/FormSubmissionController.java) | 90 |
| PUT | `/api/v1/{_}/{_}/form-templates/{_}` | `FormTemplateController#updateTemplate` (backend/src/main/java/com/mannschaft/app/forms/controller/FormTemplateController.java) | 91 |
| PUT | `/api/v1/{_}/{_}/workflow-requests/{_}` | `WorkflowRequestController#updateRequest` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowRequestController.java) | 91 |
| PUT | `/api/v1/{_}/{_}/workflow-templates/{_}` | `WorkflowTemplateController#updateTemplate` (backend/src/main/java/com/mannschaft/app/workflow/controller/WorkflowTemplateController.java) | 90 |

#### /api/v1/villages/* (47 件)
...
| PATCH | `/api/v1/villages/{_}` | `VillageController#update` (backend/src/main/java/com/mannschaft/app/village/controller/VillageController.java) | 78 |
...
| メソッド | パス | Controller | 行 |
|---|---|---|---|
| DELETE | `/api/v1/me/favorites/{_}` | `FavoriteController#removeFavorite` (backend/src/main/java/com/mannschaft/app/favorite/controller/FavoriteController.java) | 166 |
...
| DELETE | `/api/v1/me/voice-input-consents/active` | `UserVoiceInputConsentController#revokeConsent` (backend/src/main/java/com/mannschaft/app/quickmemo/controller/UserVoiceInputConsentController.java) | 56 |
...
| GET | `/api/v1/me/favorites/check` | `FavoriteController#checkFavorite` (backend/src/main/java/com/mannschaft/app/favorite/controller/FavoriteController.java) | 84 |
...
| GET | `/api/v1/me/voice-input-consents/active` | `UserVoiceInputConsentController#getActiveConsent` (backend/src/main/java/com/mannschaft/app/quickmemo/controller/UserVoiceInputConsentController.java) | 35 |
...
| PATCH | `/api/v1/system-admin/error-reports/bulk` | `SystemAdminErrorReportController#bulkUpdate` (backend/src/main/java/com/mannschaft/app/errorreport/controller/SystemAdminErrorReportController.java) | 130 |
...
| メソッド | パス | Controller | 行 |
|---|---|---|---|
| DELETE | `/api/v1/users/blocks/{_}` | `UserBlockController#unblock` (backend/src/main/java/com/mannschaft/app/user/controller/UserBlockController.java) | 50 |
...
| GET | `/api/v1/users/contact-handle-check` | `ContactHandleController#checkHandle` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactHandleController.java) | 49 |
| GET | `/api/v1/users/contact-handle/{_}` | `ContactHandleController#searchByHandle` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactHandleController.java) | 57 |
...
| GET | `/api/v1/users/me/contact-handle` | `ContactHandleController#getMyHandle` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactHandleController.java) | 34 |
| GET | `/api/v1/users/me/corkboards/{_}` | `MyCorkboardController#getBoard` (backend/src/main/java/com/mannschaft/app/corkboard/controller/MyCorkboardController.java) | 65 |
...
| PUT | `/api/v1/users/me/contact-handle` | `ContactHandleController#updateHandle` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactHandleController.java) | 41 |
...
| メソッド | パス | Controller | 行 |
|---|---|---|---|
| GET | `/api/v1/events/my-organizing/dismissal-reminders` | `EventDismissalController#getMyDismissalReminderTargets` (backend/src/main/java/com/mannschaft/app/event/controller/EventDismissalController.java) | 98 |
...
| GET | `/api/v1/shift-budget/allocations/{_}/consumption-summary` | `ShiftBudgetSummaryController#getConsumptionSummary` (backend/src/main/java/com/mannschaft/app/shiftbudget/controller/ShiftBudgetSummaryController.java) | 65 |
| POST | `/api/v1/shift-budget/alerts/{_}/acknowledge` | `BudgetThresholdAlertController#acknowledgeAlert` (backend/src/main/java/com/mannschaft/app/shiftbudget/controller/BudgetThresholdAlertController.java) | 53 |
| POST | `/api/v1/shift-budget/calc/required-slots` | `ShiftBudgetCalcController#calculateRequiredSlots` (backend/src/main/java/com/mannschaft/app/shiftbudget/controller/ShiftBudgetCalcController.java) | 66 |
...
#### /api/v1/contact-requests/* (5 件)

| メソッド | パス | Controller | 行 |
|---|---|---|---|
| DELETE | `/api/v1/contact-requests/{_}` | `ContactRequestController#cancelRequest` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactRequestController.java) | 74 |
| GET | `/api/v1/contact-requests/received` | `ContactRequestController#listReceived` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactRequestController.java) | 44 |
| GET | `/api/v1/contact-requests/sent` | `ContactRequestController#listSent` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactRequestController.java) | 51 |
| POST | `/api/v1/contact-requests/{_}/accept` | `ContactRequestController#acceptRequest` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactRequestController.java) | 58 |
| POST | `/api/v1/contact-requests/{_}/reject` | `ContactRequestController#rejectRequest` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactRequestController.java) | 66 |
...
#### /api/v1/contact-invite/* (2 件)

| メソッド | パス | Controller | 行 |
|---|---|---|---|
| GET | `/api/v1/contact-invite/{_}` | `ContactInviteController#getPreview` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactInviteController.java) | 33 |
| POST | `/api/v1/contact-invite/{_}/accept` | `ContactInviteController#acceptInvite` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactInviteController.java) | 43 |

#### /api/v1/contact-invite-tokens/* (2 件)

| メソッド | パス | Controller | 行 |
|---|---|---|---|
| DELETE | `/api/v1/contact-invite-tokens/{_}` | `ContactInviteTokenController#revokeToken` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactInviteTokenController.java) | 55 |
| GET | `/api/v1/contact-invite-tokens/{_}/qr` | `ContactInviteTokenController#getQrCode` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactInviteTokenController.java) | 63 |
...
#### /api/v1/active-incidents/* (1 件)

| メソッド | パス | Controller | 行 |
|---|---|---|---|
| GET | `/api/v1/active-incidents` | `ErrorReportController#getActiveIncidents` (backend/src/main/java/com/mannschaft/app/errorreport/controller/ErrorReportController.java) | 58 |
...
#### /api/v1/committees/* (1 件)

| メソッド | パス | Controller | 行 |
|---|---|---|---|
| PATCH | `/api/v1/committees/{_}/activity-records/{_}/confirm` | `CommitteeMinutesController#confirmMinutes` (backend/src/main/java/com/mannschaft/app/committee/controller/CommitteeMinutesController.java) | 39 |

#### /api/v1/contact-request-blocks/* (1 件)

| メソッド | パス | Controller | 行 |
|---|---|---|---|
| DELETE | `/api/v1/contact-request-blocks/{_}` | `ContactRequestBlockController#removeBlock` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactRequestBlockController.java) | 51 |

#### /api/v1/contacts/* (1 件)

| メソッド | パス | Controller | 行 |
|---|---|---|---|
| DELETE | `/api/v1/contacts/{_}` | `ContactController#deleteContact` (backend/src/main/java/com/mannschaft/app/contact/controller/ContactController.java) | 41 |
