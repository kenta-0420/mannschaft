...
| [03_role_authority_model.md](03_role_authority_model.md) | **ロール・権限モデル（認可基盤完全根治）**。JWT への SYSTEM_ADMIN 搭載・per-scope SpEL ガード・`@PreAuthorize` カタログ・段階計画 Phase 0〜6 | 🟡 設計確定（実装 Phase 0〜5 未着手）|
