...
| CMP-006 | 予約v2根本再設計 | 実機検証待ち | — | D群4弾実装・実機E2E完了（ブラウザ経路 approve-series 1件除く） | 設計 #2157(済)・D群4弾実装完了(#2525/#2536/#2539/#2553 全2026-07-30 main着地)・実機検証 #2718/#2726(2026-08-XX)・**API経由検証済**: レート上限枠/衝突予約/scope未指定/MEMBER本人(4件実走)・**残り1件**: `ReservationList.vue` の `approve-series` ブラウザクリック確認待ち | `2026-07-05-reservation-redesign.md` |
...
| CMP-023 | 時刻設計の全域是正＋テナントTZ導入（番人着地） | 実装中 | #2700 | 既存時刻関連コード4415件の番人遵守化完了 | 明文化 `16fb42d78` → 番人 #2725(`dca90f0e5`・Issue #2700・2026-08-XX main着地済)・**凍結4415件**: now()1676 / LocalDateTimeフィールド2658 / ZoneId.systemDefault()28 / TZリテラル53・既存改修進行中（Phase 1〜3見送り3項目） | — |
