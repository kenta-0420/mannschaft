-- F09.7 / F09.17 型不一致根治: ad_clicks に messaging_campaign_id (BINARY(16)) を追加する。
...
CREATE INDEX idx_ad_clicks_messaging_campaign_id ON ad_clicks (messaging_campaign_id);
