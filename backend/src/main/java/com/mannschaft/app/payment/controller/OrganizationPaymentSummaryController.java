 ...
 * 見せるべきでない財務情報のため、{@link AccessControlService#checkMembership}（"ORGANIZATION" scope）
 * で保護する。双子の {@link TeamPaymentSummaryController} も同一戦役で同水準の認可を敷設した。</p>
 */
@RestController
...
public class OrganizationPaymentSummaryController {
    ...
    public ResponseEntity<ApiResponse<PaymentSummaryResponse>> getPaymentSummary(
        ...
        accessControlService.checkMembership(SecurityUtils.getCurrentUserId(), id, "ORGANIZATION");
