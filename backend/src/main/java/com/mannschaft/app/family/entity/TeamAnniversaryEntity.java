...
public class TeamAnniversaryEntity {
    ...
    protected void onCreate() {
        ...
        if (this.repeatAnnually == null) { this.repeatAnnually = true; }
        if (this.notifyDaysBefore == null) { this.notifyDaysBefore = 1; }
    }
    ...
    public void update(String name, LocalDate date, Boolean repeatAnnually, Integer notifyDaysBefore) {
        ...
        this.repeatAnnually = repeatAnnually; this.notifyDaysBefore = notifyDaysBefore;
    }
