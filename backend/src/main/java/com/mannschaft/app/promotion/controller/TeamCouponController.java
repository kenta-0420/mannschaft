...
public class TeamCouponController {
    ...
    public ResponseEntity<PagedResponse<CouponResponse>> list(
        ...
        Page<CouponResponse> result = couponService.list("TEAM", teamId,
    ...
    public ResponseEntity<ApiResponse<CouponResponse>> get(
        ...
        return ResponseEntity.ok(ApiResponse.of(couponService.get("TEAM", teamId, id, SecurityUtils.getCurrentUserId())));
    }
    ...
    public ResponseEntity<ApiResponse<CouponResponse>> update(
            @PathVariable Long teamId, @PathVariable Long id,
            @Valid @RequestBody CreateCouponRequest request) {
        return ResponseEntity.ok(ApiResponse.of(couponService.update("TEAM", teamId, id, request, SecurityUtils.getCurrentUserId())));
    }
    ...
    public ResponseEntity<Void> delete(@PathVariable Long teamId, @PathVariable Long id) {
        couponService.delete("TEAM", teamId, id, SecurityUtils.getCurrentUserId());
    ...
    public ResponseEntity<ApiResponse<CouponResponse>> toggle(
            @PathVariable Long teamId, @PathVariable Long id) {
        return ResponseEntity.ok(ApiResponse.of(couponService.toggle("TEAM", teamId, id, SecurityUtils.getCurrentUserId())));
    }
}
