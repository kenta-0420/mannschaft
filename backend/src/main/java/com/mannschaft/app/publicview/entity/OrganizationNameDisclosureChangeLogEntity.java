...
/**
 * 組織の投稿者識別モード変更履歴エンティティ。
 *
 * <p>F19.1 Phase 2: ADMIN が {@code organizations.supporter_name_disclosure} を変更した際の
 * 監査ログを保持する。非対称切替ルール検証および UI での「過去 1 年の切替履歴表示」に使用する。</p>
 *
 * <p>設計書: docs/features/F19.1_public_pages_identity_disclosure.md §5.3</p>
 */
@Entity
@Table(name = "organization_name_disclosure_change_logs")
@Getter
@NoArgsConstructor(access = AccessLevel.PROTECTED)
@SuperBuilder
public class OrganizationNameDisclosureChangeLogEntity extends UuidV7Entity {

    /** 変更対象の組織 ID。FK 制約なし（クロスドメイン FK 禁止原則に従う）。 */
