...
public class DashboardWidgetService {
    ...
    private static final Map<String, String> WIDGET_NAMES = Map.ofEntries(
            ...
            // 対象3-A: FE personal スコープウィジェット対応の追加キー
            Map.entry("PERSONAL_TEAM_ANNOUNCEMENTS", "チームのお知らせ"),
            Map.entry("PERSONAL_ORG_ANNOUNCEMENTS", "組織のお知らせ"),
            Map.entry("PERSONAL_BLOG", "ブログ"),
            Map.entry("PERSONAL_NOTIFICATIONS", "通知"),
            Map.entry("PERSONAL_RECRUITMENT_FEED", "新着募集"),
            Map.entry("PERSONAL_MY_RECRUITMENTS", "参加予定"),
            Map.entry("PERSONAL_WEATHER", "天気"),
            Map.entry("PERSONAL_VILLAGE_LOBBY_DIGEST", "井戸端ダイジェスト"),
            Map.entry("PERSONAL_INBOX", "インボックス"),
