...
class SignageSlotServiceTest {
    ...
    class AddSlot {
        ...
        void addSlot_success_withNextOrder() {
            ...
            SignageSlotService.SignageSlotResponse result = slotService.addSlot(SCREEN_ID, req);
    ...
    class UpdateSlot {
        ...
        void updateSlot_savesSameInstance_withIdPreserved() throws Exception {
            ...
            // When
            SignageSlotService.SignageSlotResponse result = slotService.updateSlot(SLOT_ID, req);
        ...
        void updateSlot_nullRequest_preservesCurrentValues() throws Exception {
            ...
            slotService.updateSlot(SLOT_ID, req);
        ...
        void updateSlot_notFound_throws() {
            ...
            assertThatThrownBy(() -> slotService.updateSlot(SLOT_ID, req))
    ...
    class RemoveSlot {
        ...
        void removeSlot_success() throws Exception {
            ...
            slotService.removeSlot(SLOT_ID);
        ...
        void removeSlot_notFound_throws() {
            ...
            assertThatThrownBy(() -> slotService.removeSlot(SLOT_ID))
                    .isInstanceOf(BusinessException.class);
        }
    }
}
