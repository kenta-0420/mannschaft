...
/**
 * F22.1 謝礼決済 第二陣: {@link EscrowQueryService#getRecruitmentPaymentView} /
 * {@link EscrowQueryService#getEscrowView}（札主の決済確認・エスクロー照会）単体テスト。
 *
...
class ConnectChargePaymentViewTest {
    ...
    private EscrowQueryService service() {
        return new EscrowQueryService(
                escrowTransactionRepository, connectAccountRepository, stripePaymentProvider,
                accessControlService, refundRepository, new PayeeScopeResolver());
    }
    ...
    void payer_pendingConfirmation_returnsClientSecret() {
        ...
        EscrowQueryService.PaymentView view = svc.getRecruitmentPaymentView(
    ...
    void payer_authorized_noClientSecret() {
        ...
        EscrowQueryService.PaymentView view = svc.getEscrowView(ESCROW_ID, PAYER_USER_ID);
    ...
    void payeeTeamAdmin_statusOnly_noClientSecret() {
        ...
        EscrowQueryService.PaymentView view = svc.getEscrowView(ESCROW_ID, 555L);
