...
/**
 * {@link ScheduleAttendanceSpecs} の単体テスト。
 * DB なし・軽量テスト（Mockito で CriteriaBuilder/Root/CriteriaQuery をモック）。
 */
@ExtendWith(MockitoExtension.class)
@DisplayName("ScheduleAttendanceSpecs テスト")
class ScheduleAttendanceSpecsTest {

    @Mock
    private Root<ScheduleAttendanceEntity> root;
    ...
    class ByPersonOnly {
        ...
        void shouldReturnNonNullSpecification() {
            // When
            Specification<ScheduleAttendanceEntity> spec = ScheduleAttendanceSpecs.byPersonOnly();
    ...
    class IncludingProxy {
        ...
        void shouldReturnNonNullSpecification() {
            // When
            Specification<ScheduleAttendanceEntity> spec = ScheduleAttendanceSpecs.includingProxy();
